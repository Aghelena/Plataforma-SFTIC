...
const DESAFIOS = [
  {
    ...
    audio:
      "Olhe a imagem da rosquinha. Falta um pedaço. Arraste a peça correta para completar.",
    imgCompleta:
      "https://images.unsplash.com/photo-1514517116480-e3498b584e03?q=80&w=600&h=600&fit=crop",
    target: { top: 20, left: 60, width: 40, height: 40 },
    pecas: [
      {
        id: 1,
        img: "https://images.unsplash.com/photo-1579308108842-be53a23a31c5?q=80&w=200&h=200&fit=crop",
        correta: false,
        nome: "Pedaço errado",
      },
      {
        id: 2,
        img: "https://images.unsplash.com/photo-1614777986387-015c2a89b65e?q=80&w=200&h=200&fit=crop",
        correta: true,
        nome: "Pedaço certo",
      },
      {
        id: 3,
        img: "https://images.unsplash.com/photo-1596238865662-752836262b9a?q=80&w=200&h=200&fit=crop",
        correta: false,
        nome: "Pedaço errado",
      },
    ],
  },
  {
    ...
    audio:
      "Falta uma peça no quebra-cabeça do urso. Arraste a peça que combina para completar.",
    imgCompleta:
      "https://images.unsplash.com/photo-1581552807187-0f9978182bc1?q=80&w=600&h=600&fit=crop",
    target: { top: 50, left: 10, width: 40, height: 40 },
    pecas: [
      {
        id: 4,
        img: "https://images.unsplash.com/photo-1563297123-b15a6b01035b?q=80&w=200&h=200&fit=crop",
        correta: true,
        nome: "Peça certa",
      },
      {
        id: 5,
        img: "https://images.unsplash.com/photo-1571167443831-299a9a3848b3?q=80&w=200&h=200&fit=crop",
        correta: false,
        nome: "Peça errada",
      },
      {
        id: 6,
        img: "https://images.unsplash.com/photo-1579202673506-c3ce5a31ef7a?q=80&w=200&h=200&fit=crop",
        correta: false,
        nome: "Peça errada",
      },
    ],
...
export default function QuebraCabeca() {
  ...
  const [pecaSolicitadaId, setPecaSolicitadaId] = useState(null);
  ...
  const handleDrop = (e) => {
    ...
    const peca = desafioAtual.pecas.find((item) => item.id === pecaDropadaId);
      ...
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
        <div className="bg-emerald-50 p-10 rounded-[40px] border border-emerald-100 shadow-sm mb-8">
          ...
          <p className="text-2xl text-slate-600 mb-2 font-bold">
            {player?.name || "Você"} encaixou {score} peças corretas.
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full p-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        ...
        <div className="bg-white rounded-[40px] p-6 shadow-sm border border-slate-200 flex flex-col items-center gap-6">
          ...
          <p className="text-sm text-slate-400 text-center">
            Arraste a peça correta com o mouse até a área azul piscante.
          </p>
            ...
            {pecasEmbaralhadas.map((peca) => (
              <div
                ...
                className={`p-3 bg-white border-8 ${
                  pecaSolicitadaId === peca.id
                    ? "border-sky-400 scale-105 opacity-50"
                    : "border-slate-100"
                } rounded-[30px] shadow-sm flex items-center justify-center cursor-grab active:cursor-grabbing hover:border-sky-200 hover:scale-105 transition-all outline-none`}
      ...
      <footer className="p-6 text-center text-slate-400 text-sm border-t border-slate-100 mt-8">
        © {new Date().getFullYear()} Plataforma Terapêutica Inclusiva -
        Franca/SP
      </footer>
    </div>
  );
